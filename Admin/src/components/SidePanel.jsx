    ...
    return (
        ...
        <div className="__sidePanel__ w-80  h-screen flex flex-col justify-between bg-amber-800">
            ...
            <div className='flex flex-col'>
                ...
                <div className={`w-full h-10 flex items-center  text-sm text-amber-100 ${activeTab === "Dashboard" ? "bg-amber-700/20 rounded-md" : "hover:bg-amber-700/20"} hover:text-white gap-2 p-2  hover:border-0  hover:rounded-md cursor-pointer`} onClick={() => setActiveTab("Dashboard")}>
                    {Dashboard}
                    <p className=' font-semibold'>Dashboard</p>
                </div>

                <div className={`w-full h-10 flex items-center  text-sm text-amber-100 ${activeTab === "Sales" ? "bg-amber-700/20 rounded-md" : "hover:bg-amber-700/20"} hover:text-white gap-2 p-2  hover:border-0  hover:rounded-md cursor-pointer`} onClick={() => setActiveTab("Sales")}>
                    {History}
                    <p className=' font-semibold'>Sales History</p>
                </div>

                <div className={`w-full h-10 flex items-center  text-sm text-amber-100 ${activeTab === "Order" ? "bg-amber-700/20 rounded-md" : "hover:bg-amber-700/20"} hover:text-white gap-2 p-2  hover:border-0  hover:rounded-md cursor-pointer`} onClick={() => setActiveTab("Order")}>
                    {OrderManagement}
                    <p className=' font-semibold'>Order Management</p>
                </div>

                <div className={`w-full h-10 flex items-center  text-sm text-amber-100 ${activeTab === "Admin" ? "bg-amber-700/20 rounded-md" : "hover:bg-amber-700/20"} hover:text-white gap-2 p-2  hover:border-0  hover:rounded-md cursor-pointer`} onClick={() => setActiveTab("Admin")}>
                    {Admin}
