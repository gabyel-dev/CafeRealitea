    ...
    return (
        <div className="min-h-screen bg-gray-50 flex">
            ...
            <div className="flex-1 ml-65">
                ...
                <div className="max-w-full py-6 px-10">
...
<form className="space-y-10" onSubmit={handleRegister}>
  ...
  {/* Account Settings */}
  <div>
    <h3 className="text-md font-semibold text-gray-700 mb-4">Account Settings</h3>
    <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
      {/* Username */}
      <div>
  ...
  <div className="pt-6">
    <button
      type="submit"
      disabled={isLoading}
      className={`w-full flex justify-center items-center py-3 px-4 border border-transparent rounded-lg shadow-sm text-sm font-medium text-white ${isLoading ? 'bg-amber-400' : 'bg-amber-600 hover:bg-amber-700'} focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-amber-500 transition-all`}
    >
      {isLoading ? (
        <>
