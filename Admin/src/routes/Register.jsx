...
export default function Register() {
    ...
    // check user session
useEffect(() => {
    document.title = "Café Realitea - Register";
    setLoading(true);
            ...
            <div className="mt-8 sm:mx-auto sm:w-full sm:max-w-md">
                ...
                <div className="flex-1">
                    ...
                    <select
                        ...
                        onChange={handleChange}
                        className="block w-full pl-3 pr-10 py-2 border border-gray-300 rounded-md focus:ring-amber-500 focus:border-amber-500 sm:text-sm appearance-none bg-white"
                    >
